(() => {
  ...
  // Broken/missing image → show filename as a clear placeholder label (teal wash)
  ...
  // Optional screenshot carousel (only when slides are present)
